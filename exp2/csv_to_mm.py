#!/usr/bin/env python
# @see https://gist.github.com/gpoulter/2350680
# Modified by Alister Lewis-Bowen <bowena@vmware.com>
...
def tree_to_xml(root):
    ...
    key, subtree = root.popitem()
    xroot = xml.node(text=key)
    rec_tree(subtree, xroot)
    xroot['folded'] = 'false'
    return str(xml)
